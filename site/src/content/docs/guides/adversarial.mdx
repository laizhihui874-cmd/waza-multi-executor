...
```sh
# Run both packs against the default executor
waza adversarial --packs prompt-injection,scope-bypass --skill my-skill
...
| `--engine` | Product executor to use | `copilot-sdk` |
| `--skill` | Skill path/identifier (required) | — |
