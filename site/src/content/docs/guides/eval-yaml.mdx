...
| `executor`          | string    | `copilot-sdk`     | One of `copilot-sdk`, `codex-cli`, `claude-cli`, `hermes-cli`, or `generic-cli` |
| `executor_config`   | object    | —                 | Direct subprocess command, argv, output protocol, and environment allowlist |
...
| `inject_skill_body` | bool      | true              | Copilot compatibility option; CLI executors use native discovery and ignore it |
